<div class="modal fade" id="mukeshModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="p-2">
                    ...
                    <h4 class="mb-3">Private request for Mukesh</h4>
                    ...
                    <form action="{{ route('store.service') }}" method="POST">
                        @csrf
                        <input type="hidden" name="trainer" value="Mukesh">
                        <div class="mt-4">

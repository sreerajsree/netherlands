@extends('layouts.app')
@section('seo')
<title>Yoga practices - House for Positive Change</title>
    ...
    <section class="classes spad">
        <div class="container">
            <div class="p-3 text-center">
                <img width="50" height="50" src="{{ asset('assets/img/logo.png') }}" alt="Logo">
                <p class="mt-3">Incorporating physical movements, forms or shapes, breathing, embodiment, and relaxation
                    ...
                    achieving a balanced and harmonious state of being.
                </p>
            </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="blog__item border-services p-3">
                        ...
                        <div class="blog__item__text">
                            <h5><a href="{{ route('dc.yoga') }}" class="fs-26">DeepRest (Chair) Yoga</a></h5>
                            ...
                            <a href="{{ route('dc.yoga') }}" class="blog_read_more">READ MORE <span class="arrow_right"></span></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="blog__item border-services p-3">
                        ...
                        <div class="blog__item__text">
                            <h5><a href="{{ route('tyb.yoga') }}" class="fs-26">Train your Breath</a></h5>
                            ...
                            <a href="{{ route('tyb.yoga') }}" class="blog_read_more">READ MORE <span class="arrow_right"></span></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="blog__item border-services p-3">
                        ...
                        <div class="blog__item__text">
                            <h5><a href="{{ route('yopi.yoga') }}" class="fs-26">YoPi Training</a></h5>
                            ...
                            <a href="{{ route('yopi.yoga') }}" class="blog_read_more">READ MORE <span class="arrow_right"></span></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="blog__item border-services p-3">
                        ...
                        <div class="blog__item__text">
                            <h5><a href="{{ route('foundational.yoga') }}" class="fs-26">Foundational Yoga</a></h5>
                            <p class="service-ch">Seek the transformative power of Foundational Yoga with Mukesh. Enhance your strength,
                                ...
                                experience.</p>
                            <a href="{{ route('foundational.yoga') }}" class="blog_read_more">READ MORE <span class="arrow_right"></span></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="blog__item border-services p-3">
                        ...
                        <div class="blog__item__text">
                            <h5><a href="{{ route('yoga.therapy') }}" class="fs-26">Yoga Therapy</a></h5>
                            ...
                            <a href="{{ route('yoga.therapy') }}" class="blog_read_more">READ MORE <span class="arrow_right"></span></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="blog__item border-services p-3">
                        ...
                        <div class="blog__item__text">
                            <h5><a href="{{ route('trauma.yoga') }}" class="fs-26">Trauma Sensitive Yoga</a></h5>
                            ...
                            <a href="{{ route('trauma.yoga') }}" class="blog_read_more">READ MORE <span class="arrow_right"></span></a>
                        </div>
                    </div>
                </div>
            </div>
